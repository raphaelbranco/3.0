...
namespace Base30.Core.DomainObjects
{
    public class Validation
    {
        ...
        public static void ValidateMinMaxValue(double value, double min, double max, string message)
        {
        ...
        public static void ValidateMinMaxValue(float value, float min, float max, string message)
        {
            if (value < min || value > max)
            {
                throw new DomainException(message);
        ...
        public static void ValidateMinMaxValue(int value, int min, int max, string message)
        {
            if (value < min || value > max)
            {
                throw new DomainException(message);
        ...
        public static void ValidateMinMaxValue(long value, long min, long max, string message)
        {
            if (value < min || value > max)
            {
                throw new DomainException(message);
        ...
        public static void ValidateMinMaxValue(decimal value, decimal min, decimal max, string message)
        {
            if (value < min || value > max)
            {
                throw new DomainException(message);
        ...
        public static void ValidaIfFalse(bool boolvalue, string message)
        {
            if (!boolvalue)
            {
                throw new DomainException(message);
